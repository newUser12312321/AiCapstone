      ...
      <div className="max-w-[1280px] mx-auto space-y-4">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-5 gap-4">
          <section className="xl:col-span-3 border border-[var(--dash-border)] rounded-2xl bg-[var(--dash-surface)] p-4 shadow-[var(--dash-shadow-soft)]">
            <h2 className="text-base text-[var(--dash-text-secondary)] font-semibold mb-3">정상 라벨링 기준 이미지</h2>
            {!imageError ? (
              <img
              ...
              <div className="h-72 rounded-xl border border-dashed border-[var(--dash-border)] flex items-center justify-center text-sm text-[var(--dash-text-secondary)] px-4 text-center">
