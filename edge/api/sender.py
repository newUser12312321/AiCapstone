...
def create_dummy_packet(
    ...
    return InspectionPacket(
        ...
        fiducial1_x_raw=319.875,
        fiducial1_y_raw=241.0625,
        fiducial2_x_raw=961.3125,
        fiducial2_y_raw=241.9375,
        fiducial1_x_yolo=318.5,
        fiducial1_y_yolo=239.8,
        fiducial2_x_yolo=961.0,
        fiducial2_y_yolo=240.1,
